...
class MockAddMoneyData {
  ...
  static const Map<String, dynamic> banksResponse = {
    'banks': [
      {'id': '1',  'name': 'Guaranty Trust Bank',         'code': '058', 'logo': '', 'ussd_code': '*737*', 'is_active': true},
      {'id': '2',  'name': 'FirstBank of Nigeria',         'code': '011', 'logo': '', 'ussd_code': '*894*', 'is_active': true},
      {'id': '3',  'name': 'Zenith Bank',                  'code': '057', 'logo': '', 'ussd_code': '*966*', 'is_active': true},
      {'id': '4',  'name': 'Access Bank',                  'code': '044', 'logo': '', 'ussd_code': '*901*', 'is_active': true},
      {'id': '5',  'name': 'United Bank for Africa (UBA)', 'code': '033', 'logo': '', 'ussd_code': '*919*', 'is_active': true},
      {'id': '6',  'name': 'FCMB',                         'code': '214', 'logo': '', 'ussd_code': '*329*', 'is_active': true},
      {'id': '7',  'name': 'Wema Bank (ALAT)',             'code': '035', 'logo': '', 'ussd_code': '*945*', 'is_active': true},
      {'id': '8',  'name': 'Sterling Bank',                'code': '232', 'logo': '', 'ussd_code': '*822*', 'is_active': true},
      {'id': '9',  'name': 'Union Bank',                   'code': '032', 'logo': '', 'ussd_code': '*826*', 'is_active': true},
      {'id': '10', 'name': 'Fidelity Bank',                'code': '070', 'logo': '', 'ussd_code': '*770*', 'is_active': true},
    ],
  };
    ...
    'requests': [
      {
        ...
        'status': 'RequestStatus.pending',                     // was: 'pending' (enum.toString() mismatch)
      ...
      },
      {
        ...
        'dueDate': null,
        'isPrivate': true,
        'status': 'RequestStatus.paid',                        // was: 'accepted' (enum.toString() mismatch)
...
class MockNotificationData {
  static const Map<String, dynamic> preferencesResponse = {
    'preferences': {
      ...
      'promotionalOffers': false,        // was: 'promotional_offers' (same value, different key)
...
class MockTierData {
  static const Map<String, dynamic> tierResponse = {
    ...
    'single_transfer_limit': 20000.00,
